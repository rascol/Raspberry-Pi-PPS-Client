...
This test as described above was performed with a pair of RPi processors and RPi-2 was allowed to collect timings over a period of 24 hours in the default file, "/var/local/timer-distrib", with the result shown in Figure 6.
